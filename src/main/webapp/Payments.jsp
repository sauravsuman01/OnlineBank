...
<body>
<br>
<h1 align="center">Electricity Payment</h1><br><br>
<%
Connection con = null;
try{
    ...
    PreparedStatement ps = con.prepareStatement("select * from payments, banking where payments.acc = banking.acc and custid=?;");
    ps.setInt(1,x);
...
//    PreparedStatement ps1 = con.prepareStatement("select * from banking");
 //   ResultSet rs1 = ps1.executeQuery();
    ...
    %>
    <form action="PayElectricity", method="get">
