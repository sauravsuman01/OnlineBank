...
@WebServlet("/PayElectricity")
public class PayElectricity extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("select due from payments where acc = ?");
			...
			int due=0;
			UserDao.updateDue(due, user.getAccno());
